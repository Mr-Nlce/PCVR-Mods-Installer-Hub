# Mass Effect 3 VR Installer

Automated installer for MELE3-VR by dhalcyon - Mass Effect 3
Legendary Edition in full head-tracked PCVR. Real stereo depth: stand on
the Normandy SR-2, look up at the Reapers over Earth, walk the Citadel
and Tuchanka. Gamepad only.
...
> of it by itself - you do not have to unpack anything, and the other two
> games are never touched by this installer.
...
`[SystemSettings]` in GamerSettings.ini:
    ...
    Mass Effect Legendary Edition\Game\ME3\BioGame\Config\GamerSettings.ini
...
Mass Effect 3 in the launcher. On a Steam copy the Hub starts the
...
starting MassEffect3.exe directly, which would nag about a missing
