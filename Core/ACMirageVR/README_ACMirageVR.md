# Assassin's Creed Mirage VR Installer
...
HUD scale adjustment, across Basim's Baghdad.

## What it does
1. Finds your Mirage install on ANY store - Steam, Ubisoft
   Connect, Ubisoft+ / PC Game Pass (those use ACMirage_plus.exe;
...
## Requirements
- Assassin's Creed Mirage (any store version)
...
The same mod also supports Assassin's Creed Odyssey and Mirage
...
>>> Nothing is true, everything is permitted. Welcome to Baghdad.
