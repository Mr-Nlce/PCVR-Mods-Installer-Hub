...
- Option A: run `IPA.exe --revert` in the game folder, or use Steam's "Verify integrity of game files"
- Option B: delete the `Yooka-Laylee VR` folder and the desktop shortcut

>>> Grab the quill. Find the Pagies. Now in glorious 3D.
