...
$global:BannerColorMap = @{
    ...
    "name:BlackMesaSourceVR" = "#d76a27"  # Black Mesa Source VR (orange logo and HEV highlights from the bundled header)
    ...
    "Pokemon Dramatic Shape VR" = "#e8c53c"  # Dramatic Shape VR - from its tile accent
    ...
    "steam:362890" = "#613e10"  # Black Mesa
    ...
    "steam:976730"  = "#4a90c8"  # Halo MCC VR (Halo blue, matches tile accent)
    ...
    "steam:1300" = "#df6a26"  # SiN Episodes: Emergence (Freeport orange)
    ...
    "steam:1465360" = "#d96a1d"  # SnowRunner VR - off-road orange
