...
VR port of Heretic via **GZDoomVR** - hh79's PC VR fork of GZDoom. Provides full 6DoF motion controls with laser-pointer aim, snap turn, and smooth locomotion through OpenVR / SteamVR.
...
That URL points at the **Heretic + Hexen bundle (2025 enhanced re-release)**. HERETIC.WAD ships inside this package. If you already own the older standalone Heretic: Shadow of the Serpent Riders on Steam (app/2390), the new bundle is a free upgrade and your existing WAD still works.
...
Vanilla Heretic runs comfortably on basic VR-capable hardware. Heavy mods (Brutal Doom and the like) can cause framedrops - the engine's README suggests dropping supersampling to 0.9 if you hit performance trouble.
...
>>> Staff in hand. Tome of Power ready. The Serpent Riders await.
