# Cloudpunk VR Installer

Automated installer for Cloudpunk VR v1.0.0 by Astienth — gamepad-based VR support for Cloudpunk.

## What it installs
- BepInEx (IL2CPP) + CloudpunkVR plugin
- SteamVR bindings for Oculus Touch, Vive, Index, and WMR

## Requirements
- Cloudpunk owned on Steam
- SteamVR installed
...
**CloudpunkVR.cfg**
- `maxVehicleCharactersDivider` — divide max NPCs/vehicles for better performance (value of 2 reduces load noticeably; may feel empty)
...
>>> One delivery, one night, one neon city. Drive safe, Rania.
