# Assassin's Creed Valhalla VR Installer
...
HUD scale adjustment, in Valhalla's whole open world.

## What it does
1. Finds your Valhalla install on ANY store - Steam, Ubisoft
   Connect, Ubisoft+ / PC Game Pass (those use ACValhalla_Plus.exe;
...
## Requirements
- Assassin's Creed Valhalla (any store version)
...
>>> Skol! Raid England the way Odin intended.
